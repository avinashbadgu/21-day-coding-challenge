...
# Defining the top
Label(root, text='Calculator', font=("Comic Sans MS", 15), bg='LightSkyBlue1').place(x=15, y=0) 

Label(root, text='Press \'x\' twice for exponentiation', font=("Georgia", 10), bg='LightSkyBlue1').place(x=20, y=30)  # Change the background color
